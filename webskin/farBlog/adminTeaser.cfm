...
<cfoutput>
	<tr class="blog-admin">
		...
		<td class="blog-admin-manage">
			<h2>#stObj.title#</h2>
			<cfif application.security.checkPermission(permission="farBlogAdmin")><span class="blog-admin-settings"><a href="#application.url.webtop#/conjuror/invocation.cfm?objectid=#stObj.objectid#&method=edit&ref=typeadmin&module=#url.module#&plugin=#url.plugin#&finishurl=">Edit General Settings</a></span></cfif>
			<div class="blog-admin-actions">
				...
				<cfif application.security.checkPermission(permission="farBlogPostApprove")><a href="#application.url.webtop#/admin/customadmin.cfm?module=customlists/farBlogPost.cfm&plugin=farcryblog&farBlogID=#stObj.objectid#&status=pending">Posts Awaiting Approval #stStats.pending_posts#</a></cfif>
