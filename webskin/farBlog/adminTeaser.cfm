	...
	<tr class="blog-admin">
		...
		<td class="blog-admin-manage">
			...
			<div class="blog-admin-actions">
				...
				<cfif application.security.checkPermission(permission="farBlogPostApprove") or application.fapi.hasRole("sysadmin")><a href="#application.url.webtop#/admin/customadmin.cfm?module=customlists/farBlogPost.cfm&plugin=farcryblog&farBlogID=#stObj.objectid#&status=pending">Posts Awaiting Approval #stStats.pending_posts#</a></cfif>
