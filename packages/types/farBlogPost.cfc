...
<cfcomponent displayname="Blog Post" extends="farcry.core.packages.types.versions" bRSSFeed="true" bSchedule="true" bFriendly="true" bObjectBroker="true" lObjectBrokerWebskins=""
